...
import 'package:image_detection_demo/main.dart';
import 'package:image_detection_demo/manual/face-identifier.dart';

import 'builders.dart';
import 'enum_handler.dart';
import 'face_camera.dart';
import 'paint/face_painter.dart';
...
class _SmartFaceCameraState extends State<SmartFaceCamera>
  ...
  void _getAllAvailableCameraLens() {
    for (CameraDescription d in cameras_) {
      //FaceCamera.cameras) {
  ...
  Future<void> _initCamera() async {
    final cameras = cameras_ // FaceCamera.cameras
        .where((c) =>
            c.lensDirection ==
