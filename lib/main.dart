...
//   bool isBusy = false;
//   late Size size;
//   late CameraDescription description = cameras_[1];
...
//         performanceMode: FaceDetectorMode.accurate, enableClassification: true);
...
//             if (!isBusy) {frame = image, doFaceDetectionOnFrame()}
//           });
//     });
//   }
//
...
//     final camera =
//         camDirec == CameraLensDirection.front ? cameras_[1] : cameras_[0];
...
//       description = cameras_[1];
//     } else {
//       camDirec = CameraLensDirection.back;
//       description = cameras_[0];
//     }
